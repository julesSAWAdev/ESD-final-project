...
if(isset($_POST["submit"])){
    ...
    $query = "INSERT INTO courses(names,CourseCode,length) VALUES ('$name','$code','$length')";
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12"> 
                                ...
                                <form role="form" action="courseaction" method="POST">
                                    <div class="form-group"><label>Course Name</label> <input type="text" name="cname" placeholder="Course Name" class="form-control"></div>
                                    <div class="form-group"><label>Course Code</label> <input type="text" name="ccode" placeholder="course Code" class="form-control"></div>
                                    <div class="form-group"><label>Course Length</label> <input type="number" name="clength" placeholder="Course credits" class="form-control"></div>
                                    <div>
